{
  services.udev.extraRules = ''
    ...
    GROUP="dialout", SYMLINK+="android%n"

    # Devices listed here {begin...end} are connected by USB
    LABEL="android_usb_rules_end"

    # Qualcomm EDL
    SUBSYSTEMS=="usb", ATTRS{idVendor}=="05c6", ATTRS{idProduct}=="9008", MODE="0666", GROUP="dialout"

    # Qualcomm Memory Debug
    SUBSYSTEMS=="usb", ATTRS{idVendor}=="05c6", ATTRS{idProduct}=="9006", MODE="0666", GROUP="dialout"

    # Qualcomm Memory Debug
    SUBSYSTEMS=="usb", ATTRS{idVendor}=="05c6", ATTRS{idProduct}=="900E", MODE="0666", GROUP="dialout"

    # LG Memory Debug
    SUBSYSTEMS=="usb", ATTRS{idVendor}=="1004", ATTRS{idProduct}=="61a1", MODE="0666", GROUP="dialout"

    # Sierra Wireless
    SUBSYSTEMS=="usb", ATTRS{idVendor}=="1199", ATTRS{idProduct}=="9071", MODE="0666", GROUP="dialout"
  '';
}
